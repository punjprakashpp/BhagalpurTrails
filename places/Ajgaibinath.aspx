<%@ Page Title="" MasterPageFile="~/places/place.master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Ajgaibinath Temple</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container">
        ...
        <h1 class="mt-4 mb-3">Ajgaibinath Temple</h1>

        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="../index.html">Home</a>
            </li>
            <li class="breadcrumb-item active">Ajgaibinath Temple</li>
        </ol>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <a href="#lightbox" onclick="displayImage('img/ajgaibinath/ajgaibinath(3).png'); return false;">
                    <img class="img-fluid" src="img/ajgaibinath/ajgaibinath(3).png" alt="">
                </a>
            </div>
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <a href="#lightbox" onclick="displayImage('img/ajgaibinath/ajgaibinath(10).png'); return false;">
                    <img class="img-fluid" src="img/ajgaibinath/ajgaibinath(10).png" alt="">
                </a>
            </div>
